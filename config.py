...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "Lonly_xyz")
BOT_USERNAME = os.getenv("BOT_USERNAME", "Jio_Saavn_Bot")
...
SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/Updates_Jiosaavn")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/+FvMi1igOXv1iMDI1")
